...
filter_description = [("bedroom", "latent", room_size, True)]
...
stats = 0 #If true, print stats about the dataset
save_freq = 0 #If true, save category frequency count to the dest directory
...
graphs = 0 #If true, save relationship graph files
