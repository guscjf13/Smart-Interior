...
public class CreateRoom : MonoBehaviour
{
    ...
    public void getJson()
    {
        ...
        String temp = System.IO.File.ReadAllText("C:/Users/hyunchul/Desktop/house.json");
        ...
        {
            string modelId = jsonNodes[i]["modelId"].ToString();
    ...
    static void DoExport(bool makeSubmeshes, GameObject gameObject)
    {
        ...
        string fileName = "C:/Users/hyunchul/Desktop/" + meshName + ".obj";
